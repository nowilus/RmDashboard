        ...
        <TableCustom stickyHeader aria-label="sticky table">
            <TableHeadCustom>
                ...
                {tableColumns && tableColumns.map((tableColumn, index) => (
                    <TableCellHead key={index}>{tableColumn}</TableCellHead>
                ))}
                </TableRowHead>
            </TableHeadCustom>
            <TableBodyCustom>
                ...
                <TableRowBody key={index}>
                    <TableCellBody id='td'>{content.type}</TableCellBody>
                    <TableCellBody id='td'>{content.id}</TableCellBody>
                    <TableCellBody id='td'>{content.name}</TableCellBody>
                    <TableCellBody id='td'>
